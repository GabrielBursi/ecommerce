...
router.patch('/cart/quant/:userId/:productId', ensureAuthenticated, searchId, ProductsController.alterQuantProductValidation, ProductsController.AlterQuantProduct) //* PRIVATE
...
router.delete('/cart/clear/:id', ensureAuthenticated, searchId, ProductsController.ClearCart) //* PRIVATE
router.delete('/cart/remove/:userId/:productId', ensureAuthenticated, searchId, ProductsController.excludeProductCartValidation, ProductsController.ExcludeProductCart) //* PRIVATE
router.delete('/favorite/remove/:userId/:productId', ensureAuthenticated, searchId, ProductsController.excludeProductFavoriteValidation, ProductsController.ExcludeProductFavorite) //* PRIVATE
