...
exports.ExcludeProductCart = exports.excludeProductCartValidation = void 0;
...
exports.excludeProductCartValidation = (0, middleware_1.validation)({
    params: paramsSchemaValidation
});
const ExcludeProductCart = async (req, res) => {
    const { id: productId } = req.params;
    const userId = res.locals.userId;
    const productDeleted = await providers_1.ProductsProviders.excludeProductCart(userId, productId);
