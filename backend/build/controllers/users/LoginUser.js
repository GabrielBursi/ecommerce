...
exports.LoginUser = exports.loginUserValidation = void 0;
...
exports.loginUserValidation = (0, middleware_1.validation)({
...
const LoginUser = async (req, res) => {
    ...
    const compareHashPassword = await services_1.PasswordCrypto.verifyPassword(password, user.password);
    ...
    return res.status(http_status_codes_1.StatusCodes.OK).json({ accessToken, user });
};
